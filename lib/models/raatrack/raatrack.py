...
from lib.models.raatrack.vit_cae_async import CAE_Base_patch16_224_Async
...
class RAATrack(nn.Module):
    """ This is the base class for RAATrack """
...
def build_RAATrack(cfg, training=True):

    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    #print(current_dir)
    pretrained_path = os.path.join(current_dir, '/home/spc/桌面/tracking/RAATrack-main/pretrained_models/cae_base.pth')
   # print(pretrained_path)
    if cfg.MODEL.PRETRAIN_FILE and ('RAATrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    if 'RAATrack' in cfg.MODEL.PRETRAIN_FILE and training:
