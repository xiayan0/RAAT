    ...
    def __init__(self, actor, loaders, optimizer, settings, lr_scheduler=None, use_amp=False, cfg=None):
        ...
        if settings.local_rank in [-1, 0]:
            ...
            if settings.use_wandb:
                ...
                self.wandb_writer = WandbWriter(settings.project_path[6:], cfg, tensorboard_writer_dir, cur_train_samples, interval,)
    ...
    def cycle_dataset(self, loader):
        ...
        for i, data in enumerate(loader, 1):
            ...
            if self.wandb_writer is not None and i % self.settings.print_interval == 0:
                ...
                #     x,x2,y,y2 = stats['Coord'][0],stats['Coord'][1],stats['Coord'][2],stats['Coord'][3]
                #     img = wandb.Image(data['search_images'][0][0],boxes={
                #         "predictions": {
                #             "box_data": [{
                ...
                #     self.stats['train']['search_img'] = img
