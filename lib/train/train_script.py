...
from lib.models import build_ostrack, build_RAATrack
...
def run(settings):
    ...
    elif settings.script_name == "raatrack":
        net = build_RAATrack(cfg)
    else:
    ...
    qfl = QFL()
    # negL = negL()
    if settings.script_name == "ostrack" or settings.script_name == "raatrack":
