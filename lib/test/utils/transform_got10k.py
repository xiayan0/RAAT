...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg_name', default='B9_cae_center_got10k_ep100_100', type=str, help='Name of config file.')
    ...
    listglob.sort()
    src_list = listglob
    dst_list = [ os.path.join(result_dir, "%s/got10k_submit/%s/"
